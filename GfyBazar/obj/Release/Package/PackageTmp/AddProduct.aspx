<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" ValidateRequest="false" Inherits="GfyBazar.AddProduct" %>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" id="redeemshopping" runat="server" visible="false">
                        <div class="form-group">
                            <label>
                                Shopping Point Redeem <span style="color: red">*</span>
                            </label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <asp:Button ID="btnsave" runat="server" CssClass="btn btn-success btn-sm" Text="Save" OnClick="btnsave_Click" OnClientClick="return fvalidate();" />
                    </div>
                </div>
            </div>
        </div>
