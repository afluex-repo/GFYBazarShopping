...
namespace GfyBazar.Controllers
{
    public class CustomerController : Controller
    {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows[0][0].ToString() == "1")
                    {
                        ...
                        TempData["SaveAddress"] = " updated successfully";
                        model.Result = "Color updated successfully";
                    }
        ...
        public ActionResult Invoice(string ono)
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //ViewBag.CompanyName = "GfyBazar";
                    //ViewBag.CompanyAddress = "D-54 Arjun Tower, Vibhuti Khand, Lucknow - 226010";
                    //ViewBag.Website = "www.GfyBazar.com";
                    //ViewBag.CompnayEmail = "support@GfyBazar.com";
        ...
        public ActionResult UpdatePassword(Customer obj)
        {
            string FormName = "";
            string Controller = "";
            try
