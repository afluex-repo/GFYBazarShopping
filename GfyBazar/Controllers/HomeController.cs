...
using static GfyBazar.Models.Home;
using System.Net;
using System.Xml;
using System.Text;
using System.IO;
...
namespace GfyBazar.Controllers
{
    public class HomeController : Controller
    {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    if (ds.Tables[0].Rows[0]["MSG"].ToString() == "1")
                    {
                        ...
                        try
                        {
                            ...
                            + "Dear " + model.DisplayName + ",<br/> Welcome to the seller club of Gfy Bazar.<br/>Please"
                            ...
                            + "<h4 style = 'color:white'><i class='fa fa-volume-control-phone' aria-hidden='true'></i> &nbsp; Website : <i>http://www.GfyBazar.com/</i></h4>"
                            ...
                            myMail.From = new MailAddress("grazieforyouventures@gmail.com", "GFY Bazar");
        ...
        public ActionResult CustomerRegistration(string CustomerName, string Contact)
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows[0][0].ToString() == "1")
                    {
                        ...
                        string str = "Dear " + CustomerName + ",You have been successfully registered as GfyBazar Customer, your Login ID is " + ds.Tables[0].Rows[0]["LoginId"].ToString() + " and  Password is : " + Crypto.Decrypt(ds.Tables[0].Rows[0]["Password"].ToString());
        ...
        public ActionResult RefundAndCancellationsPolicy()
        {
            return View();
        }
